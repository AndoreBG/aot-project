...
| **Integridade Física** | Estado do corpo — afeta performance | Não se "ganha"; apenas se perde menos | Quedas, ataques pesados, uso excessivo do ODM em braços feridos | Braço ferido = gancho mais lento. Perna ferida = salto menor. Dano acumulado cria uma **espiral descendente**. |
